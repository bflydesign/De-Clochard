...
<form id="frmContact" method="post" action="#focus">
    ...
    <div class="field">
        ...
        <div class="right">
            <input type="text" name="confirm_email" id="confirm_email" class="field-input"
                   data-validation=" required email compare_email"
    ...
    <div class="field">
        <label for="message">
            <span class="required">*</span> Uw bericht
                ...
                <textarea class="field-input" name="message" id="message"
                          data-validation="required"><?php print isset($_POST['message']) ? str_replace('<br />', "\n", $_POST['message']) : ''; ?></textarea>
    </div>
